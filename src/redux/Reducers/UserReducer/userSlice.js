...
import { getOtherUsers, getHistory, sendInternalChat, setAllRead, getAzleUserInfo, setFacebook, setHD, importHDPhotoHub, setEmail, saveEmail, updatePassword, updateAvatar, setCall, setLiveChat, purchasePhoneNumber, migratePhoneNumber } from "./actions";

export const getUserInfo = createAsyncThunk(
  "user/getUserInfo", 
  async () => getAzleUserInfo()
);
...
export const updateAzlePassword = createAsyncThunk(
  "user/updatePassword", 
